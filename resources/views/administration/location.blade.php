<x-app-layout>  
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        ...
        <form action="{{ route('locations') }}" method="GET" style="margin-bottom:2%; justify-content:center; align-items:center; display:flex;">
            <input type="text" name="search" placeholder="Rechercher un locataire..." value="{{ request()->input('search') }}">
